...
class AdminUserController extends Controller
{
    ...
    function delete($id){
        if(Auth::id()!=$id){
            ...
            return redirect('admin/user/list')->with('status','Xóa bản ghi thành công!');
        }else{
            return redirect('admin/user/list')->with('status','Bạn không thể xóa bản ghi này!');
        }
    }
       ...
       if($list_check){
           ...
           if(!empty($list_check)){
               ...
               if($act=='forceDelete'){
                    ...
                    return redirect('admin/user/list')->with('status','Bạn đã xóa vĩnh viễn tài khoản!');
               }
           }else{
                return redirect('admin/user/list')->with('status','Bạn không thể xóa bản ghi này!');
           }
       }else{
            return redirect('admin/user/list')->with('status','Bạn cần chọn tài khoản để thực hiện thao tác!');
       }
    }
}
