                    ...
                    <ul class="list-item">
                        ...
                        <li>
                            ...
                            <div class="action clearfix">
                                ...
                                <a href="{{route('buynow',$item->id)}}" title="" class="buy-now fl-right">Mua ngay</a>
                            </div>
                        </li>
                        @endforeach
                    </ul>
                    ...
                    <ul class="list-item clearfix">
                        ...
                        <li>
                            ...
                            <div class="action clearfix">
                                ...
                                <a href="{{route('buynow',$laptop->id)}}" title="Mua ngay" class="buy-now fl-right">Mua ngay</a>
                            </div>
                        </li>
                        @endforeach
                    </ul>
            ...
            <div class="section" id="list-product-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        ...
                        <li>
                            <a href="{{route('detail.product',$telephone->id)}}" title="" class="thumb">
                                <img src="{{$telephone->thumbnail}}">
                            </a>
                            <a href="{{route('detail.product',$telephone->id)}}" title="" class="product-name">{{$telephone->name}}</a>
                            <div class="price">
                                <span class="new">{{number_format($telephone->price,0,',','.')}}đ</span>
                                <span class="old">16.490.000đ</span>
                            </div>
                            <div class="action clearfix">
                                <a href="{{route('addcart',$telephone->id)}}" title="Thêm giỏ hàng" class="add-cart fl-left">Thêm giỏ hàng</a>
                                <a href="{{route('buynow',$telephone->id)}}" title="Mua ngay" class="buy-now fl-right">Mua ngay</a>
                            </div>
                        </li>
                        @endforeach
                    </ul>
