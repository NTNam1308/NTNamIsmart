                        ...
                        <div class="wp-inner">
                            ...
                            <div id="search-wp" class="fl-left">
                                <form method="POST" action="{{route('search')}}">
                                    @csrf
                                    <input type="text" name="search" id="s" value="{{request()->input('search')}}" placeholder="Nhập từ khóa tìm kiếm tại đây!">
                            ...
                            <div id="action-wp" class="fl-right">
                                ...
                                <a href="{{route('showcart')}}" title="giỏ hàng" id="cart-respon-wp" class="fl-right">
                                ...
                                <div id="cart-wp" class="fl-right">
                                    ...
                                    <div id="dropdown">
                                        ...
                                        <dic class="action-cart clearfix">
                                            <a href="{{route('showcart')}}" title="Giỏ hàng" class="view-cart fl-left">Giỏ hàng</a>
